...
export class Ball extends PIXI.Graphics {
  ...
  constructor(screen: PIXI.Rectangle, collisions: PIXI.Graphics[]) {
    super();
    this.beginFill(0xffffff);
    this.drawCircle(0, 0, 5);
    this.setTransform(screen.width / 2, screen.height / 2);
    this.screen = screen;
    this.collisionsToTest = collisions;
  }
  ...
  addToCollision = (o: PIXI.Graphics): void => {
    this.collisionsToTest.push(o);
  }
